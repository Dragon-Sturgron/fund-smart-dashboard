...
1. 东方财富历史净值接口；
2. 东方财富基金详情页的 `Data_netWorthTrend` 走势数据；
3. 仅在前两项都失败时，通过 Jina Reader 代理原历史净值接口。

`r.jina.ai/https://guba.eastmoney.com/list,of基金代码.html` 是基金吧讨论页面，适合后续做舆情摘要，不用于历史净值计算。
